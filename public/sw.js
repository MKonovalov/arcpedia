// Minimal service worker. Its ONLY purpose is to make arcpedia an installable PWA,
// which is what unlocks the Web Share Target (sharing a link to arcpedia from the
